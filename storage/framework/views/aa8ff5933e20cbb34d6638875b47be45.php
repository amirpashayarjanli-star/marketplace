...
<div class="min-h-screen flex items-center justify-center relative overflow-hidden py-8 px-4">
    ...
    <div class="w-full max-w-md">
        ...
        <div class="backdrop-blur-xl bg-white/30 border border-white/40 rounded-3xl shadow-2xl p-8 md:p-10">
            ...
            <form method="POST" action="<?php echo e(route('register.otp')); ?>" class="space-y-8">
                <?php echo csrf_field(); ?>
                ...
                <div class="text-center">
                    <a href="<?php echo e(route('register')); ?>" class="text-sm text-blue-600 hover:text-yellow-500 font-semibold transition">
                        بازگشت
                    </a>
                </div>
            </form>
