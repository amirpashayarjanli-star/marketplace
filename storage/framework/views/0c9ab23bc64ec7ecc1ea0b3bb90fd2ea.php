...
<div class="min-h-screen flex items-center justify-center relative overflow-hidden py-8 px-4">
    ...
    <div class="text-center">
        ...
        <div class="flex gap-4 justify-center flex-wrap">
            <a href="<?php echo e(route('home') ?? '/'); ?>" class="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-2xl hover:shadow-lg transition">
                بازگشت به خانه
            </a>
            <a href="<?php echo e(route('login')); ?>" class="px-8 py-3 border-2 border-blue-600 text-blue-600 font-bold rounded-2xl hover:bg-blue-50 transition">
                ورود به حساب
            </a>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\AsansorPRO\marketplace\resources\views/errors/404.blade.php ENDPATH**/ ?>