...
<div class="min-h-screen py-8 px-4">
    ...
    <div class="mb-8">
        <h1 class="text-4xl font-bold text-gray-900 mb-2">
            ✏️ ویرایش پروفایل تکنسین
        </h1>
        <p class="text-gray-600">
            اطلاعات و مهارت‌های خود را بروزرسانی کنید
        </p>
    </div>
    ...
    <div class="backdrop-blur-xl bg-white/80 border border-white/40 rounded-3xl shadow-xl p-8 md:p-10 max-w-4xl">
        ...
        {{-- Success Message --}}
        @if(session('success'))
            <div class="bg-gradient-to-r from-purple-500/20 to-indigo-500/20 border border-purple-500/50 text-purple-700 p-4 rounded-2xl mb-6 flex items-start gap-3">
                <i class="fa-solid fa-circle-check mt-1 flex-shrink-0 text-purple-600"></i>
            ...
            <form method="POST" action="{{ route('dashboard.profile.update') }}" class="space-y-6">
                ...
                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    ...
                    <div class="relative group">
                        ...
                        <select
                            name="city"
                            class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 pr-12 text-gray-800 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('city') ? 'ring-2 ring-red-500' : '' }}"
                        >
                    ...
                    <div class="relative group">
                        <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                            <i class="fa-solid fa-map text-purple-600 group-focus-within:text-purple-500 transition"></i>
                        </div>
                        <input
                            type="text"
                            name="province"
                ...
                <div class="relative group">
                    ...
                    <textarea
                        name="skills"
                        placeholder="مهارت‌های شما (مثال: تعمیر موتور، نصب نرم، الکتریکی)"
                        rows="4"
                ...
                <div class="relative group">
                    <div class="absolute top-4 right-0 flex items-center pr-4 pointer-events-none">
                        <i class="fa-solid fa-location-dot text-purple-600 group-focus-within:text-purple-500 transition"></i>
                    </div>
                    <textarea
                        name="address"
                ...
                <div class="relative group">
                    <div class="absolute top-4 right-0 flex items-center pr-4 pointer-events-none">
                        <i class="fa-solid fa-align-left text-purple-600 group-focus-within:text-purple-500 transition"></i>
                    </div>
                    <textarea
                        name="description"
                        placeholder="درباره خود و تجربیات خود توضیح دهید"
                        rows="5"
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 pr-12 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-purple-500 focus:border-transparent backdrop-blur-sm transition-all"
