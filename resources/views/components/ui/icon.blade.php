...
@php
    ...
    $paths = match ($key) {
        ...
        */
        ...
        /*
        | شمش طلا — سه شمش روی هم (یکی بالا، دوتا پایین).
        |
        | دو تلاش قبلی یک ذوزنقه‌ی تکی بود و هر بار چیز دیگه‌ای خونده
        | می‌شد: اول وزنه، بعد اتو. یک ذوزنقه به‌تنهایی معنی «طلا» نمی‌ده؛
        | چیدمان هرمیِ سه‌تایی همون نشانه‌ی شناخته‌شده‌ی شمش طلاست.
        */
        'gold-bar'     => '<path d="M9.3 5.8h5.4l1.15 4.3H8.15Z"/><path d="M4.3 13.4h5.4l1.15 4.3H3.15Z"/><path d="M14.3 13.4h5.4l1.15 4.3H13.15Z"/>',
