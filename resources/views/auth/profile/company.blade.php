        ...
        <div class="backdrop-blur-xl bg-white/30 border border-white/40 rounded-3xl shadow-2xl p-8 md:p-10">
            ...
            <div class="text-center mb-8">
                ...
                <p class="text-gray-600 mt-2 text-sm">
                    اطلاعات شرکت آسانسوری خود را تکمیل کنید
                </p>
            ...
            <form method="POST" action="{{ route('register.profile.store') }}" class="space-y-4">
                ...
                <div class="relative group">
                    <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none">
                        <i class="fa-solid fa-briefcase text-blue-600 group-focus-within:text-yellow-500 transition"></i>
                    </div>
                    <input
                        type="text"
                        name="company_name"
                        ...
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 pr-12 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('company_name') ? 'ring-2 ring-red-500' : '' }}"
                        required
                    >
                ...
                <div class="relative group">
                    <div class="absolute inset-y-0 right-0 flex items-center pr-4 pointer-events-none z-10">
                        <i class="fa-solid fa-map-location-dot text-blue-600 group-focus-within:text-yellow-500 transition"></i>
                    </div>
                    <select
                        name="city"
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 pr-12 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('city') ? 'ring-2 ring-red-500' : '' }}"
                        required
                    >
                ...
                <div class="relative group">
                    <textarea
                        name="description"
                        placeholder="توضیحات و معرفی شرکت"
                        rows="4"
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('description') ? 'ring-2 ring-red-500' : '' }}"
                ...
                <div class="text-center">
                    <a href="{{ route('register.type') }}" class="text-sm text-blue-600 hover:text-yellow-500 font-semibold transition">
                        بازگشت
                    </a>
                </div>
            </form>
