            ...
            <form method="POST" action="{{ route('register.profile.store') }}" class="space-y-4">
                ...
                <div class="relative group">
                    ...
                    <input
                        ...
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 pr-12 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('store_name') ? 'ring-2 ring-red-500' : '' }}"
                        required
                    >
                ...
                <div class="relative group">
                    ...
                    <select
                        name="city"
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 pr-12 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('city') ? 'ring-2 ring-red-500' : '' }}"
                        required
                    >
                ...
                <div class="relative group">
                    ...
                    <input
                        ...
                        inputmode="numeric"
                        pattern="[0-9\s\-\+\(\)]{10,20}"
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 pr-12 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('phone') ? 'ring-2 ring-red-500' : '' }}"
                    >
                    <label class="absolute -top-2.5 right-4 text-xs font-semibold bg-white/80 px-2 text-gray-700">
                        شماره تماس
                    </label>
                ...
                <div class="relative group">
                    <textarea
                        ...
                        rows="4"
                        class="w-full bg-white/50 border border-white/60 rounded-2xl px-5 py-3.5 text-gray-800 placeholder-gray-500 focus:outline-none focus:ring-2 focus:ring-green-500 focus:border-transparent backdrop-blur-sm transition-all {{ $errors->has('description') ? 'ring-2 ring-red-500' : '' }}"
                ...
                <div class="text-center">
                    <a href="{{ route('register.type') }}" class="text-sm text-green-600 hover:text-green-500 font-semibold transition">
                        بازگشت
                    </a>
                </div>
            </form>
