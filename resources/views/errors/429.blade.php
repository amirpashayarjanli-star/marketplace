...
<div class="min-h-screen flex items-center justify-center relative overflow-hidden py-8 px-4">
    ...
    <div class="text-center">
        ...
        <p class="text-gray-600 text-lg mb-8 max-w-md mx-auto">
            شما درخواست‌های بسیاری ارسال کرده‌اید. لطفاً چند لحظه صبر کنید و دوباره تلاش کنید.
        </p>

        <div class="flex gap-4 justify-center flex-wrap">
            <a href="javascript:history.back()" class="px-8 py-3 bg-gradient-to-r from-blue-600 to-blue-700 text-white font-bold rounded-2xl hover:shadow-lg transition">
                بازگشت
            </a>
